...
for row_id in range(len(sheet_data)):
    ...
    print(f"{cheap_flight.destination_city}: {cheap_flight.price}")
    ...
    if cheap_flight:
        ...
        if cheap_flight.price < row["lowestPrice"]:
            ...
            message_text = f"Low price alert! Only £{cheap_flight.price} " \
            ...
            print(message_text)
            link = f"https://www.google.co.uk/flights?hl=en#flt={cheap_flight.origin_airport}.{cheap_flight.destination_airport}.{cheap_flight.out_date}*{cheap_flight.destination_airport}.{cheap_flight.origin_airport}.{cheap_flight.return_date}"
